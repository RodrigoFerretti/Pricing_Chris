...
CREATE TABLE IF NOT EXISTS `pedregulho`.`Location` (
  ...
  INDEX `location_state_id_idx` (`state_id`) ,
...
CREATE TABLE IF NOT EXISTS `pedregulho`.`Client` (
  ...
  PRIMARY KEY (`id`),
  INDEX `client_segment_id_idx` (`segment_id`) ,
  INDEX `client_location_id_idx` (`location_id`) ,
...
CREATE TABLE IF NOT EXISTS `pedregulho`.`locationprice` (
  ...
  INDEX `location_price_product_id_idx` (`product_id`) ,
  INDEX `location_price_location_id_idx` (`location_id`) ,
  INDEX `location_price_segment_id_idx` (`segment_id`) ,
...
CREATE TABLE IF NOT EXISTS `pedregulho`.`cityprice` (
  ...
  INDEX `city_price_product_id_idx` (`product_id`) ,
  INDEX `city_price_city_id_idx` (`city_id`) ,
  INDEX `city_price_segment_id_idx` (`segment_id`) ,
...
CREATE TABLE IF NOT EXISTS `pedregulho`.`stateprice` (
  ...
  INDEX `state_price_product_id_idx` (`product_id`) ,
  INDEX `state_price_state_id_idx` (`state_id`) ,
  INDEX `state_price_segment_id_idx` (`segment_id`) ,
